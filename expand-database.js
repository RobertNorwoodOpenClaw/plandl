...
// Search Wikimedia Commons and download image
async function fetchAircraftImage(searchTerm, outputFilename) {
...
const newAircraft = [
  ...
  // Additional popular GA aircraft
...
async function main() {
  console.log('Starting aircraft database expansion...');
